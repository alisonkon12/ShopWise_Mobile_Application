package com.example.shopwise.search;
...
import com.example.shopwise.AndroidUtil;
...
public class MenuView extends LinearLayout {
    ...
    private void init() {
        ...
        mActionIconColor = AndroidUtil.getColor(getContext(), R.color.red);
        mOverflowIconColor = AndroidUtil.getColor(getContext(), R.color.red);
    }
